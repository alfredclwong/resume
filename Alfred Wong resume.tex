...
2019 - present & \multicolumn{2}{p{\linegoal}}{
    \vspace{-2.9mm}\textbf{Feature Selection for ITE Counterfactual Generation using GANs}
    \begin{compact}
        \item Masters Project on medical machine learning, supervised by Prof. Mihaela van der Schaar
        \item Building on existing ideas, using GANs to generate counterfactuals and NNs for feature selection
        \vspace{-.5\baselineskip}
    \end{compact}
}\\
...
2018 - 2020 & \multicolumn{2}{l}{\textbf{Engineering Tripos Reports \& Mathematical Tripos CATAM}}\\&
\begin{compact}
	\vspace{-.5\baselineskip}
